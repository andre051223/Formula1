document.addEventListener('DOMContentLoaded', () => {
  ...
  let clasificacion = [
    { equipo:'Red Bull', piloto: 'Max Verstappen', puntos: 273 },
    { equipo:'Red Bull',piloto: 'Yuki Tsunoda', puntos: 20 },
    { equipo:'Ferrari',piloto: 'Lewis Hamilton', puntos: 127 },
    { equipo:'Ferrari',piloto: 'Charles Leclerc', puntos: 173 },
    { equipo:'Mercedes',piloto: 'George Russell', puntos: 237 },
    { equipo:'Mercedes',piloto: 'Kimi Antonelli', puntos: 88 },
    ...
    { equipo:'Aston Martin',piloto: 'Fernando Alonso', puntos: 34 },
    ...
    { equipo:'Williams',piloto: 'Carlos Sainz', puntos: 32 },
