document.addEventListener('DOMContentLoaded', () => {
  ...
  let clasificacion = [
    { equipo:'Red Bull', piloto: 'Max Verstappen', puntos: 341 },
    { equipo:'Red Bull',piloto: 'Yuki Tsunoda', puntos: 28 },
    { equipo:'Ferrari',piloto: 'Lewis Hamilton', puntos: 148 },
    { equipo:'Ferrari',piloto: 'Charles Leclerc', puntos: 214 },
    { equipo:'Mercedes',piloto: 'George Russell', puntos: 276 },
    { equipo:'Mercedes',piloto: 'Kimi Antonelli', puntos: 122 },
    { equipo:'McLaren',piloto: 'Oscar Piastri', puntos: 366 },
    { equipo:'McLaren',piloto: 'Lando Norris', puntos: 390 },
    { equipo:'Visa RB',piloto: 'Isack Hadjar', puntos: 43 },
    { equipo:'Visa RB', piloto: 'Liam Lawson', puntos: 36 },
    { equipo:'Aston Martin',piloto: 'Fernando Alonso', puntos: 40 },
    { equipo:'Aston Martin',piloto: 'Lance Stroll', puntos: 32 },
    { equipo:'Alpine',piloto: 'Pierre Gasly', puntos: 22 },
    ...
    { equipo:'Kick Sauber',piloto: 'Nico Hulkenberg', puntos: 43 },
    { equipo:'Haas',piloto: 'Oliver Bearman', puntos: 40 },
