document.addEventListener('DOMContentLoaded', () => {
  ...
  let clasificacion = [
    { equipo:'Red Bull', piloto: 'Max Verstappen', puntos: 281 },
    { equipo:'Red Bull',piloto: 'Yuki Tsunoda', puntos: 22 },
    { equipo:'Ferrari',piloto: 'Lewis Hamilton', puntos: 130 },
    { equipo:'Ferrari',piloto: 'Charles Leclerc', puntos: 177 },
    { equipo:'Mercedes',piloto: 'George Russell', puntos: 244 },
    { equipo:'Mercedes',piloto: 'Kimi Antonelli', puntos: 89 },
    { equipo:'McLaren',piloto: 'Oscar Piastri', puntos: 336 },
    { equipo:'McLaren',piloto: 'Lando Norris', puntos: 314 },
    { equipo:'Visa RB',piloto: 'Isack Hadjar', puntos: 39 },
    { equipo:'Visa RB', piloto: 'Liam Lawson', puntos: 30 },
    { equipo:'Aston Martin',piloto: 'Fernando Alonso', puntos: 32 },
    ...
    { equipo:'Kick Sauber',piloto: 'Nico Hulkenberg', puntos: 36 },
